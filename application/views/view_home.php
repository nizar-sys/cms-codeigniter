                ...
                <div class="col-lg-4 col-md-6">
                    <div class="services-item effect-item">
                        ...
                        <div class="services-text">
                            ...
                            <div class="button-bn">
                                <a href="<?php echo base_url(); ?>service/view/<?php echo $row['id']; ?>"><?php echo BACA_SELENGKAPNYA; ?> <i class="fa fa-chevron-circle-right"></i></a>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="row">
            <div class="col-12">
                <div class="headline">
                    ...
                    <h3>Member Terbaik Peraih Bonus & Bintang</h3>
                </div>
            </div>
        </div>
        <div class="row">
                ...
                <div class="testimonial-carousel owl-carousel mt-30">
                    ...
                    foreach ($testimonials as $row) {
                        ?>
                           ...
                           <div class="gallery-group">
                        <div class="gallery-produk" style="background-image: url(<?php echo base_url(); ?>public/uploads/<?php echo $row['photo']; ?>)">
